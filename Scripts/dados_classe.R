yf.shapiro(dn ~ group, dados_classe)
byf.shapiro(dc ~ group, dados_classe)
leveneTest(dn ~ group, dados_classe, center=mean)
...
# ANOVA de Welch (não exige variâncias iguais) + pós-teste de Games–Howell.

welch_dc <- oneway.test(dc ~ group, dados_classe, var.equal = FALSE)
welch_dc
